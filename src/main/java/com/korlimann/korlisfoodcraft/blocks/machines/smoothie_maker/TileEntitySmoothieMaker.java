...
public class TileEntitySmoothieMaker extends TileEntity implements IInventory, ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "container.smoothie_maker";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockSmoothieMaker.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = SmoothieMakerRecipes.getInstance().getIceResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = SmoothieMakerRecipes.getInstance().getIceResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
